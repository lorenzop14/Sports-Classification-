Train of a deep learning model (DenseNet-like architecture) to classify images into 12 sports-related categories.
After preprocessing the data I developed a DenseNet architecture designed to learn discriminative features
